...
<center>
    ...
    <form action="/jsploginservlet" >

        <div id="blink6"><h1>{ Enter You login and password }</h1></div>
        <table>
            <tr>
                <td><strong>[ Login: ]</strong></td>
                <td>
                    <input type="email" maxlength="30" size="40" name="txt_login_name" required/>
                </td>
            </tr>
            <tr>
                <td><strong>[ Password: ]</strong></td>
                <td>
                    <input type="password" maxlength="20" size="40" name="txt_passwd_name" required/>
                </td>
            </tr>
            <tr>
        ...
        <div id="blink7"><a href="/pages/register.html">[ Registration ]</a></div>
    </form>
